...
/**
 * Recursive descent syntax that builds an Abstract Syntax Tree (AST) from a stream of tokens.
 * <p>
 ...
 * Parser syntax = new Parser(tokens, sourceCode, functionRegistry, unitRegistry);
 * Node ast = syntax.parse();
 * }</pre>
 *
 * @see TokenStream
...
public final class Parser {
    ...
    /**
     * Creates a new syntax with the given tokens, registries, and full configuration.
     *
    ...
    public Parser(List<Token> tokens, String sourceCode, int maxExpressionDepth,
        ...
        // Create precedence syntax with max expression depth and arithmetic mode
