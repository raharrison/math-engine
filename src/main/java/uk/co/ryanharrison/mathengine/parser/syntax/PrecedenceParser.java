...
public final class PrecedenceParser {
    ...
    /**
     * Creates a new precedence syntax with the specified configuration.
     *
     * @param stream                the token stream
     * @param collectionParser      syntax for collections (vectors, matrices)
     ...
     * <p>
     * Counted by every construct that makes this syntax call itself: a grouping, a vector,
